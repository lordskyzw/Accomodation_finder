                    ...
                    <div class="main_footer wow fadeInDown" data-wow-duration="2s">
                        <div class="col-sm-3 col-xs-12">
                            <div class="footer_logo">
                                <a href=""><h2 style="color: white; font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif";>UTOPIA</h2></a>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="footer_bottom_area">
                        <div class="col-sm-9 col-xs-12">
                          <h3>This webapp was developed by :</h3>
                          <h3>Tarmica Chiwara</h3>
                          <br/>
                          <h4>Positions for joining the project are being exclusively offered to Computer Engineering & I.T students only</h4>
                          <br/>
                          <br/>
                        </div>

                        <div class="col-sm-3 col-xs-12">
                          <h4><label>Contact info :</label></h4> <h4><a href="wa.me?=+263779281345" style="color:rgb(56, 196, 56); font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif; font-size: large;">+263 779 281 345</a></h4>
                          <h4>
                            <label>Email : tarimicac@gmail.com</label>
                          </h4>
                        </div>
                    </div>
                </div>
